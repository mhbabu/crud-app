            ...
            if (form.valid()) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.success == false) {
                            ...
                            $.each(data.error, function(index, error) {
                                errorMessage.removeClass('d-none').append(
                                    '<li style="list-style: none">' + error +
                                    '</li>');
                            });
                    ...
                    error: function(data) {
                        ...
                        console.log(errors);
                        alert(
                            'Sorry, an unknown Error has been occurred ! Please try again later.');
                    }
                });
                return false;
            }
